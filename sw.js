const CACHE_NAME='caderno-digital-v116';
const APP_FILES=['./','./index.html','./style.css','./subject-detection.js','./app.js','./extras.js','./manifest.webmanifest','./icons/app-icon.svg','./icons/app-icon-192.png','./icons/app-icon-512.png'];
