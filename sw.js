const CACHE_NAME='caderno-digital-v119';
const APP_FILES=['./','./index.html','./style.css','./subject-detection.js','./recording-media.js','./recording-sync.js','./app.js','./extras.js','./manifest.webmanifest','./icons/app-icon.svg','./icons/app-icon-192.png','./icons/app-icon-512.png'];
